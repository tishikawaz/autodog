module fortran_programmer_module
    ...
    ! ------------------------------------------------------------------------
    ! ------
    !  This module defines a Fortran programmer class that extends the
    ! programmer class.
    !  It contains methods to initialize the programmer and print their
    ! language.
    ! 
    !  Public Types:
    !    fortran_programmer_class: A derived type that extends the programmer
    ! class.
    ! 
    !  Public Methods:
    !    initialize: Initializes the programmer with a specified language or
    ! defaults to 'Fortran'.
    ...
    subroutine initialize(self, language)
        ...
        !  It assigns the `language` attribute of the `self` object with the
        ! provided `language` value.
        !  If `language` is not provided, it assigns the `language` attribute with
        ! the default value 'Fortran'.
        !  Parameters:
        !    - self: The `self` object of type `fortran_programmer_class`.
        !    - language: The language to assign to the `language` attribute of the
    ...
    subroutine who_is(self)
        !  This subroutine prints the type of programmer based on the language
        ! attribute of the fortran_programmer_class object.
        ! 
        !  Parameters:
        !    self: inout, class(fortran_programmer_class)
        !        The object of type fortran_programmer_class whose language
        ! attribute will be used to determine the type of programmer.
        ! 
        !  Output:
        !    None
        ! 
        ...
        ! 
        !    This will print the type of programmer based on the language
        ! attribute of my_programmer object.
        ! 
        !    For example, if my_programmer%language is 'Fortran', the output will
        ! be 'I am Fortran programmer'.
        class(fortran_programmer_class), intent(inout) :: self
